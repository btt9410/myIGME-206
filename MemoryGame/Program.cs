        ...
        start:
            ...
            while (!bTimeOut)
            {
                ...
                if (sAnswer.ToUpper() == displayString && !bTimeOut)
                {
                    ...
                    Console.WriteLine("Great job, your score is " + displayString.Length);
                }
                else
                {
                    // 9. otherwise display the correct code sequence and their final score (displayString.Length - 1)
                    Console.WriteLine("Timeout! Your score is " + (displayString.Length - 1) + ". The correct code was " + displayString);
