                    ...
                    for (int nCntr = 0; nCntr < Cell.MAX_NEIGHBORS; ++nCntr)
                    {
                        ...
                        switch (nCntr)
                        {
                            ...
                            case (int)EDirection.up:
                                ...
                                break;
                            case (int)EDirection.upright:
                                if (col < MAX_COLS - 1 && row > 0)
                                {
                                    neighborCell = organism[row - 1, col + 1];
                                }
                                break;
                            case (int)EDirection.upleft:
                                if (row > 0 && col > 0)
                                {
                                    neighborCell = organism[row - 1, col - 1];
                                }
                                break;
                            case (int)EDirection.downright:
                                if (col < MAX_COLS - 1 && row < MAX_ROWS - 1)
                                {
                                    neighborCell = organism[row + 1, col + 1];
                                }
                                break;
                            case (int)EDirection.downleft:
