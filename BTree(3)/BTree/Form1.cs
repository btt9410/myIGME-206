...
namespace BTree
{
    public partial class Form1 : Form
    {
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree("STARK", null);
            root = node;
            node = new BTree("TARGARYEN", root);
            node = new BTree("LANNISTER", root);
            node = new BTree("BARATHEON", root);
            node = new BTree("TYRELL", root);
            node = new BTree("MARTELL", root);
            node = new BTree("GREYJOY", root);
            node = new BTree("ARRYN", root);
            node = new BTree("TULLY", root);
            node = new BTree("MORMONT", root);
            node = new BTree("TARLY", root);
            node = new BTree("FREY", root);
            node = new BTree("BOLTON", root);
            node = new BTree("CLEGANE", root);
            node = new BTree("DAYNE", root);
